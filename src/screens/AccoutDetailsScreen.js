...
export default class AccoutDetailsScreen extends Component {
    ...
    onBack = () => {
        ...
        console.log('BankAccountScreen')
    }

    onContinue = () => {
        this.props.navigation.navigate('AccoutDetailsScreen');
                ...
                >
                        ...
                        >
                            ...
                            >
                                <Input
                                    ...
                                    name="confirmAccount"
                                    onChangeText={(value) => this.setState({ confirmAccount: value })}
                                    style={[styles.cardNumberfull, styles.listItemTextSize]}
                                    maxLength={16}
                                    keyboardType='numeric'
                                />
                    ...
                    <View
                        ...
                        <View style={[styles.btnView]}>
                            ...
                            >
                                <Text style={[styles.whiteText]}>Save Account</Text>
                            </Button>
                        </View>
                    </View>
                </Content>
