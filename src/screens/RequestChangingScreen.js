...
export default class RequestDetailScreen extends Component {
    ...
    onContinue = () => {
        requestamoutdetail.amount = number;
        requestamoutdetail.reserve = this.state.reserve;
        this.props.navigation.navigate('RequestDateScreen', requestamoutdetail);
        number = '';
    }
                ...
                <Content>
                    <View style={[styles.cardView, styles.centerView]}>
                        ...
                        >
                            ...
                            >
                                <Text>ENTER CHARGING AMOUNT</Text>
                                <Text style={[styles.listAmount]}>${this.state.amount}</Text>
                            </CardItem>

                            <CardItem
                                style={[styles.cardItemBottomStyle, styles.centerView]}
                            >
                                <Left><Text style={[styles.grayText]}>$ {this.state.reserve}</Text></Left>
                    ...
                    >
                        <View style={[styles.numberView, styles.centerView]}>
                            ...
                            <View style={[{ flexDirection: 'row', height: hp(10), width: wp(80) }, styles.centerView]}>
                                <View style={[{ flex: 1, height: hp(10) }, styles.centerView]}>
                                    <Button transparent disabled={this.state.isDisabled}
